                ...
                <div class="result-title">
                    <div class="result-list">
                    	<form action="AddGuitar" method="post">
							编 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="text" name="serialNumber"><br/>
							价 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;格：<input type="text" name="price"><br/>
							生 &nbsp;产 &nbsp;商：<input type="text" name="builder"><br/>
							型 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="text" name="type"><br/>
							背板材料：<input type="text" name="backWood"><br/>
							前板材料：<input type="text" name="topWood"><br/>
